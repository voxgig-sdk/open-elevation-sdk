...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.OPEN_ELEVATION_TEST_LIVE ||
    'TRUE' === process.env.OPEN_ELEVATION_TEST_OVERRIDE
  ) {
  ...
  m.OPEN_ELEVATION_TEST_EXPLAIN = process.env.OPEN_ELEVATION_TEST_EXPLAIN || m.OPEN_ELEVATION_TEST_EXPLAIN
