...
AQL-driven CLI and REPL for the OpenElevation SDK. Positional arguments are
...
./open-elevation-cli load 1 lookup
./open-elevation-cli load '{id:1}' lookup
