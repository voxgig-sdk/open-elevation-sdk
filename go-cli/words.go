...
func registerSDKWords(r *eng.Registry, client *sdk.OpenElevationSDK) {
...
func runOp(client *sdk.OpenElevationSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
