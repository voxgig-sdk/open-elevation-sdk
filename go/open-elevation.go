...
// instead of `sdk.NewOpenElevationSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *OpenElevationSDK  { return NewOpenElevationSDK(nil) }
func Test() *OpenElevationSDK { return TestSDK(nil, nil) }
