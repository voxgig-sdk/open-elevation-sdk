# OpenElevation Golang SDK Reference

Complete API reference for the OpenElevation Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *OpenElevationSDK`
...
#### `Lookup(data map[string]any) OpenElevationEntity`
