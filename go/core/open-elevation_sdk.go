...
func (sdk *OpenElevationSDK) OptionsMap() map[string]any {
...
func (sdk *OpenElevationSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *OpenElevationSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *OpenElevationSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenElevationSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *OpenElevationSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *OpenElevationSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("OpenElevationSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *OpenElevationSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *OpenElevationSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("OpenElevationSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func TestSDK(testopts map[string]any, sdkopts map[string]any) *OpenElevationSDK {
	...
	sdk := NewOpenElevationSDK(sdkopts)
	sdk.Mode = "test"
