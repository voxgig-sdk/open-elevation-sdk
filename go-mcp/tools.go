...
type Args struct {
	Entity string         `json:"entity" jsonschema:"lookup"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.OpenElevationSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-elevation_list",
		Description: "List records from OpenElevation. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "open-elevation_load",
		Description: "Load a single record from OpenElevation. " +
...
func runOp(client *sdk.OpenElevationSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.OpenElevationSDK, name string) (sdk.OpenElevationEntity, error) {
