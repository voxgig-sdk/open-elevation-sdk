// Command OpenElevation-mcp is an MCP server exposing the OpenElevation
// SDK as MCP tools.
//
// Two tools are registered:
//
//	OpenElevation_list  — list records of an entity
//	OpenElevation_load  — load a single record of an entity
//
