# OpenElevation SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions OpenElevationSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both OpenElevationSDK(...) and OpenElevationSDK.test(...) become
#      OpenElevationSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "openelevation_sdk"
_SDK_CLASS = "OpenElevationSDK"
