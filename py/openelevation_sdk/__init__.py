...
from openelevation_sdk.utility import register

# Load features
from openelevation_sdk.feature.base_feature import OpenElevationBaseFeature
from openelevation_sdk.features import _has_feature, _make_feature
...
class OpenElevationSDK:
    ...
    def get_utility(self):
        return OpenElevationUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("OpenElevationSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Lookup(self, data=None) -> "LookupEntity":
        ...
        from openelevation_sdk.entity.lookup_entity import LookupEntity
