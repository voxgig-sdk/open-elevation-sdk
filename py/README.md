# OpenElevation Python SDK



The Python SDK for the OpenElevation API — an entity-oriented client following Pythonic conventions.

The SDK exposes the API as capitalised, semantic **Entities** — for example `client.Lookup()` — each
...
release tag (`py/vX.Y.Z`, see [Releases](https://github.com/voxgig-sdk/open-elevation-sdk/releases)) or
...
```
py/
├── openelevation_sdk.py         -- Main SDK module
