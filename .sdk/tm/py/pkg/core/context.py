...
from projectname_sdk.core.control import OpenElevationControl
...
class OpenElevationContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = OpenElevationControl()
        ...
        if isinstance(sp, OpenElevationSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, OpenElevationResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, OpenElevationResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return OpenElevationError(code, msg, self)
