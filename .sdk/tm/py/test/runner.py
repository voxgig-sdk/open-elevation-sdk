...
class OpenElevationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenElevationTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = OpenElevationTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = OpenElevationTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
