...
class OpenElevationTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = OpenElevationTestRunner.getenv("PROJECTNAME_TEST_LIVE")
        override = OpenElevationTestRunner.getenv("PROJECTNAME_TEST_OVERRIDE")
        ...
        explain = OpenElevationTestRunner.getenv("PROJECTNAME_TEST_EXPLAIN")
