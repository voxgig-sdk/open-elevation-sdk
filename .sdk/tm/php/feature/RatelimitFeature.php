...
// OpenElevation SDK ratelimit feature
...
class OpenElevationRatelimitFeature extends OpenElevationBaseFeature
{
    ...
    private function _acquire(OpenElevationContext $ctx): void
    {
    ...
    private function _track(OpenElevationContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
