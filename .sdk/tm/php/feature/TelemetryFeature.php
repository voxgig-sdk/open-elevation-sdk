...
// OpenElevation SDK telemetry feature
...
class OpenElevationTelemetryFeature extends OpenElevationBaseFeature
{
    ...
    private function _close(OpenElevationContext $ctx, bool $ok): void
    {
