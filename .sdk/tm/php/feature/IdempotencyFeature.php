...
// OpenElevation SDK idempotency feature
...
class OpenElevationIdempotencyFeature extends OpenElevationBaseFeature
{
    ...
    private function _mutating(OpenElevationContext $ctx): bool
    {
