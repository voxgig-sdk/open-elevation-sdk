...
// OpenElevation SDK streaming feature
...
class OpenElevationStreamingFeature extends OpenElevationBaseFeature
{
    ...
    private function _iterate(OpenElevationResult $result): \Generator
    {
    ...
    private function _streamable(OpenElevationContext $ctx): bool
    {
