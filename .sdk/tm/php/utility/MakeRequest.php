...
// OpenElevation SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class OpenElevationMakeRequest
{
    public static function call(OpenElevationContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new OpenElevationResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new OpenElevationResponse($fetched);
        } else {
