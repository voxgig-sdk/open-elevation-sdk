...
// OpenElevation SDK utility: graphql
//
...
class OpenElevationGraphql
{
    ...
    // equivalent.
    public static function body(OpenElevationContext $ctx): mixed
    {
    ...
    public static function errors(OpenElevationContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
