...
function runner.env_override(m)
  local live = runner.getenv("OPENELEVATION_TEST_LIVE")
  local override = runner.getenv("OPENELEVATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPENELEVATION_TEST_EXPLAIN")
