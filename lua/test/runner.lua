...
function runner.env_override(m)
  local live = runner.getenv("OPEN_ELEVATION_TEST_LIVE")
  local override = runner.getenv("OPEN_ELEVATION_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("OPEN_ELEVATION_TEST_EXPLAIN")
