...
// OpenElevation SDK utility type

class OpenElevationUtility
{
    ...
    public static function copy(OpenElevationUtility $src): OpenElevationUtility
    {
        $u = new OpenElevationUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
