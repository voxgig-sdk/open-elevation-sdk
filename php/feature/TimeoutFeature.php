...
// OpenElevation SDK timeout feature
...
class OpenElevationTimeoutFeature extends OpenElevationBaseFeature
{
    ...
    private function _with_timeout(OpenElevationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(OpenElevationContext $_ctx, float $ms): void
    {
        $client = $this->client;
