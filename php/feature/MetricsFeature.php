...
// OpenElevation SDK metrics feature
...
class OpenElevationMetricsFeature extends OpenElevationBaseFeature
{
    ...
    private function _record(OpenElevationContext $ctx, bool $ok): void
    {
