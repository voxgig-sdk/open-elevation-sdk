...
// OpenElevation SDK clienttrack feature
...
class OpenElevationClienttrackFeature extends OpenElevationBaseFeature
{
    ...
    public function PostConstruct(OpenElevationContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'OpenElevation-SDK';
