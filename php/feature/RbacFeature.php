...
// OpenElevation SDK rbac feature
...
class OpenElevationRbacFeature extends OpenElevationBaseFeature
{
    ...
    private function _required(OpenElevationContext $ctx): ?string
    {
    ...
    private function _reject(OpenElevationContext $ctx, string $required): void
    {
    ...
    private function _track(OpenElevationContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
