...
// OpenElevation SDK netsim feature
...
class OpenElevationNetsimFeature extends OpenElevationBaseFeature
{
    ...
    private function _simulate(OpenElevationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(OpenElevationContext $ctx, array $applied): void
    {
        $client = $this->client;
