...
// OpenElevation SDK audit feature
...
class OpenElevationAuditFeature extends OpenElevationBaseFeature
{
    ...
    private function _emit(OpenElevationContext $ctx, string $outcome): void
    {
