...
// OpenElevation SDK cache feature
...
class OpenElevationCacheFeature extends OpenElevationBaseFeature
{
    ...
    private function _through(OpenElevationContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
