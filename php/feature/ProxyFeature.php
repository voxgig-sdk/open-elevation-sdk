...
// OpenElevation SDK proxy feature
...
class OpenElevationProxyFeature extends OpenElevationBaseFeature
{
    ...
    public function init(OpenElevationContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (OpenElevationContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
