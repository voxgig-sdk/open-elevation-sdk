...
// OpenElevation SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (OpenElevationSDK::test)
...
{
    private const SDK_CLASS = 'OpenElevationSDK';
    ...
    private const SDK_BASE = 'openelevation_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../openelevation_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
