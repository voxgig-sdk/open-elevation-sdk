...
// OpenElevation SDK utility: fetcher

class OpenElevationFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; OpenElevationSDK/1.0)';
    ...
    public static function call(OpenElevationContext $ctx, string $fullurl, array $fetchdef): array
    {
