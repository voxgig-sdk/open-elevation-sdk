# OpenElevation PHP SDK



The PHP SDK for the OpenElevation API — an entity-oriented client using PHP conventions.
...
```
php/
├── openelevation_sdk.php          -- Main SDK class
...
The main class (`openelevation_sdk.php`) exports the SDK class
