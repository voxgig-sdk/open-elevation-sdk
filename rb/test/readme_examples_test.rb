...
#      offline in seeded test mode (OpenElevationSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "OpenElevation_sdk.rb")
  SDK_CLASS = "OpenElevationSDK"
