...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/open-elevation` | `npm install @voxgig-sdk/open-elevation` |
| Python | `voxgig-sdk-open-elevation` | `pip install voxgig-sdk-open-elevation` |
| PHP | `voxgig-sdk/open-elevation` | `composer require voxgig-sdk/open-elevation` |
| Golang | `github.com/voxgig-sdk/open-elevation-sdk/go` | `go get github.com/voxgig-sdk/open-elevation-sdk/go` |
| Ruby | `voxgig-sdk-open-elevation` | `gem install voxgig-sdk-open-elevation` |
| Lua | `voxgig-sdk-open-elevation` | `luarocks install voxgig-sdk-open-elevation` |
